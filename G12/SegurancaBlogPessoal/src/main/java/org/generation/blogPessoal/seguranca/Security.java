...
protected void configure(AuthenticationManagerBuilder auth) throws Exception{
	auth.userDetailsService(userDetailsService)//autentica usuário e senha
	.passwordEncoder(new BCryptPasswordEncoder());	//O sistema vai criptografar tanto a senha salva, 
													//quanto a senha digitada, ele compara as duas e autentica
													//se é a mesma que está no banco
}																											
